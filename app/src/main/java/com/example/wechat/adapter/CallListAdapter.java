...
public class CallListAdapter extends RecyclerView.Adapter<CallListAdapter.Holder> {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(@NonNull View itemView) {
            ...
            tvName = itemView.findViewById(R.id.textViewNameContactsID);
            tvDate = itemView.findViewById(R.id.textViewDateID);
            profile = itemView.findViewById(R.id.imageProfileContactsID);
            arrow = itemView.findViewById(R.id.imgArrowID);
